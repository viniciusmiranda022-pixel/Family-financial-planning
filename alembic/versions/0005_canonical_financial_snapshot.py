...
def upgrade() -> None:
    ...
    if "financial_snapshots" not in tables:
        op.create_table(
            ...
            sa.Column("commitments", sa.Numeric(14, 2), nullable=True),
            sa.Column("budget_cap", sa.Numeric(14, 2), nullable=True),
            sa.Column("budget_remaining", sa.Numeric(14, 2), nullable=True),
